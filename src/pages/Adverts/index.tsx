					...
					<div className="card4">
						...
						<div className="comment">
							...
							<p>
								...
								adipisicing elit. Eligendi aliquam, quas sint
								voluptas nobis laborum facere! Soluta illum
								temporibus voluptatem quae possimus aut
								accusamus quo. Consequatur corporis deleniti
								voluptatibus aut!
							</p>
						</div>
					...
					<div className="card5">
						...
						<div className="divpublication">
							<textarea className="publication">
								Carro muito confortável, foi uma ótima
